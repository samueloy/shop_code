<template>
    <div class="index" v-cloak>
        ...
        <div class="news acea-row row-between-wrapper">
            <div class="pictrue"><img src="@assets/images/tit1.png" /></div>
        ...
        >
            <router-link
                :to="{
                path: '/goods_list',
                query: { id: info.fastList[0].id, title: info.fastList[0].cate_name }
              }"
            ...
            <div class="list acea-row row-column-between">
                <router-link
                    :to="{
                path: '/goods_list',
                query: { id: info.fastList[index + 1].id, title: info.fastList[index + 1].cate_name }
              }"
                    class="item"
        ...
        <div class="wrapper" v-if="info.fastList.length > 0">
            <div class="title acea-row row-between-wrapper">
                <div class="text">
                    ...
                    <img src="@assets/images/tit2.png" />
                </div>
