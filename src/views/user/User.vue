<template>
  <div class="user">
    ...
    <div class="wrapper">
      <div class="nav acea-row row-middle hide" v-if="1 !== 1" style="display: none!important;">
        ...
        <router-link :to="'/user/user_coupon'" class="item hide">
          <div>优惠券</div>
...
<!--     <img src="@assets/images/support.png" class="support" />-->
      <div class="supports">绿动网络提供技术支持</div>
...
export default {
  ...
  methods: {
    ...
    goPages: function(index) {
      ...
      if (index == 3){
          window.location.href = 'tel://' + 13867388868;
      } else {
